    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gray-100 px-4">
            <div className="w-full max-w-4xl bg-white rounded-xl mt-[5%] shadow-lg p-8 md:p-12">
                <h2 className="text-3xl font-bold text-center text-green-400 mb-8">Semiwholesaler Register</h2>
                <form onSubmit={handleSubmit(handleregister)} className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="md:col-span-2">
                        <button
                            type="submit"
                            className="w-1/3 cursor-pointer bg-green-400 text-white py-3 rounded-md hover:bg-green-500 transition font-semibold"
                        >
                            Register
                        </button>
                    </div>
                ...
                <p className="text-xl text-center text-gray-600 mt-6">
                    ...
                    <span
                        ...
                        onClick={() => navigate("/semiwholesaler/login")}
                    >
                        Login
                    </span>
                </p>
...
export default semiwholesalerRegister